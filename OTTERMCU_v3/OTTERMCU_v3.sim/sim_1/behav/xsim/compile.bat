...
REM
REM Generated by Vivado on Thu Mar 12 16:48:50 -0700 2026
...
echo "xvlog --incr --relax -L uvm -prj OTTERMCUwrappersim_vlog.prj"
call xvlog  --incr --relax -L uvm -prj OTTERMCUwrappersim_vlog.prj -log xvlog.log
